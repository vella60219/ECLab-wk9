...
// SSID & Password
const char* ssid = "VELLA";
const char* password = "7ze2pzv5b82sq";
    ...
    <head>\
      <style>\
        body{ display: flex; flex-direction: row;}\
         a { background: #CEF2F4; color:#ff00e6; width: 200px; height: 50px; margin: 20px; font-size: 30pt; text-decoration: none;}\
      </style>\
    </head>\
    <body>\
